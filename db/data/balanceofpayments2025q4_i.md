...
본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_I` 시트(분류: **자본·금융계정**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 부표 차원: **Cr / Dr / Bal 3분할**
- 시트 단위 BoP 위계: **자본수지 KA**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | I.1 KA Credits | `balanceofpayments2025q4_i_sub1.csv` |
| 2 | I.2 KA Debits | `balanceofpayments2025q4_i_sub2.csv` |
| 3 | I.3 KA Balances | `balanceofpayments2025q4_i_sub3.csv` |
