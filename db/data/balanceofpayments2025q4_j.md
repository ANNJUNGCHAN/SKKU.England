...
본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_J` 시트(분류: **자본·금융계정**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 부표 차원: **NAFA / NIL / Net 3분할**
- 시트 단위 BoP 위계: **금융계정 5분류 양면 (슬라이드 14 식 1:1 동형)**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | J.1 NAFA | `balanceofpayments2025q4_j_sub1.csv` |
| 2 | J.2 NIL | `balanceofpayments2025q4_j_sub2.csv` |
| 3 | J.3 Net Transactions | `balanceofpayments2025q4_j_sub3.csv` |
