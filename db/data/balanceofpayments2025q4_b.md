...
본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_B` 시트(분류: **경상수지 본표**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 부표 차원: **Cr / Dr / Bal + %GDP 4분할**
- 시트 단위 BoP 위계: **CA 4분류 합계**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | B.1 CA Credits | `balanceofpayments2025q4_b_sub1.csv` |
| 2 | B.2 CA Debits | `balanceofpayments2025q4_b_sub2.csv` |
| 3 | B.3 CA Balances | `balanceofpayments2025q4_b_sub3.csv` |
| 4 | B.4 CA Balances %GDP | `balanceofpayments2025q4_b_sub4.csv` |
