...
본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_K` 시트(분류: **국제투자대조표**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 부표 차원: **Assets / Liabilities / Net 3분할 (stock)**
- 시트 단위 BoP 위계: **IIP 양면 잔액**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | K.1 UK Assets | `balanceofpayments2025q4_k_sub1.csv` |
| 2 | K.2 UK Liabilities | `balanceofpayments2025q4_k_sub2.csv` |
| 3 | K.3 Net IIP | `balanceofpayments2025q4_k_sub3.csv` |
