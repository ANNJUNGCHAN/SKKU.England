...
본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_G` 시트(분류: **경상수지 세부**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 부표 차원: **Cr / Dr / Bal 3분할**
- 시트 단위 BoP 위계: **1차소득 PI**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | G.1 PI Credits | `balanceofpayments2025q4_g_sub1.csv` |
| 2 | G.2 PI Debits | `balanceofpayments2025q4_g_sub2.csv` |
| 3 | G.3 PI Balances | `balanceofpayments2025q4_g_sub3.csv` |
