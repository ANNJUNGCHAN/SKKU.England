# Table_D7_9 — 한국어 메타 메모

본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_D7_9` 시트(분류: **국제투자대조표**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 부표 차원: **IIP / Flow / Income 3분할 (순)**
- 시트 단위 BoP 위계: **IIP·FA·1차소득 순**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | D.7 Net IIP | `balanceofpayments2025q4_d7_9_sub1.csv` |
| 2 | D.8 Net FA tx | `balanceofpayments2025q4_d7_9_sub2.csv` |
| 3 | D.9 Net Income | `balanceofpayments2025q4_d7_9_sub3.csv` |
