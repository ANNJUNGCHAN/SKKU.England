# Table_D1_3 — 한국어 메타 메모

본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_D1_3` 시트(분류: **국제투자대조표**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 부표 차원: **IIP / Flow / Income 3분할 (자산 측)**
- 시트 단위 BoP 위계: **IIP·FA·1차소득 자산**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | D.1 IIP abroad | `balanceofpayments2025q4_d1_3_sub1.csv` |
| 2 | D.2 FA tx abroad | `balanceofpayments2025q4_d1_3_sub2.csv` |
| 3 | D.3 Income abroad | `balanceofpayments2025q4_d1_3_sub3.csv` |
