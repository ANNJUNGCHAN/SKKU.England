...
본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_F` 시트(분류: **경상수지 세부**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 시트 단위 BoP 위계: **서비스수지 S (EBOPS 12)**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | F.1 Exports of services | `balanceofpayments2025q4_f_sub1.csv` |
| 2 | F.2 Imports of services | `balanceofpayments2025q4_f_sub2.csv` |
| 3 | F.3 Balances of services | `balanceofpayments2025q4_f_sub3.csv` |
