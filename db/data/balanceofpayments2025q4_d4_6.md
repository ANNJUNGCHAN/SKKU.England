# Table_D4_6 — 한국어 메타 메모

본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_D4_6` 시트(분류: **국제투자대조표**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 부표 차원: **IIP / Flow / Income 3분할 (부채 측)**
- 시트 단위 BoP 위계: **IIP·FA·1차소득 부채**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | D.4 IIP in UK | `balanceofpayments2025q4_d4_6_sub1.csv` |
| 2 | D.5 FA tx in UK | `balanceofpayments2025q4_d4_6_sub2.csv` |
| 3 | D.6 Income in UK | `balanceofpayments2025q4_d4_6_sub3.csv` |
