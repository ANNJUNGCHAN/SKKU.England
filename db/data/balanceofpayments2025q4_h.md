...
본 메모는 ONS BoP Bulletin 2025 Q4 xlsx의 `Table_H` 시트(분류: **경상수지 세부**)를 Phase 2.1 ETL로 가공한 부표 CSV들의 한국어 메타 안내이다.
...
- 부표 차원: **Cr / Dr / Bal 3분할**
- 시트 단위 BoP 위계: **2차소득 SI**

| 부표 # | 영문 라벨 | 출력 CSV |
|---:|---|---|
| 1 | H.1 SI Credits | `balanceofpayments2025q4_h_sub1.csv` |
| 2 | H.2 SI Debits | `balanceofpayments2025q4_h_sub2.csv` |
| 3 | H.3 SI Balances | `balanceofpayments2025q4_h_sub3.csv` |
