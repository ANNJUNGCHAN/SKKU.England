...
- [x] **[background-search]** EU/非EU 분해 표의 한국어 정의·분해 기준·해석상 유의점 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §4 Table_C. 한국어 STAT_NAME(「경상수지 (EU/non-EU)」), Table_B의 4 하위 + 합계를 거래 상대방 국가군(EU vs non-EU)으로 분해한 분기표 6 부표(추정 매핑: 상품·서비스·1차·2차·CA합계·Memo aggregates), Brexit(2020-02-01) 후 EU27(영국 제외) 전환 + ONS 시계열 일관성을 위한 과거 재계산, EU 흑자가 non-EU 적자로 상쇄될 때 합계가 0 부근으로 보일 수 있는 해석 유의점, Table_B Balances 합계와의 교차 검증 정합. **EU/non-EU 분류 자체는 강의 자료 미수록 → background/note/23 (Pink Book Ch.9·EU27 전환) 보강 완료**(04회차 검증 보고서 결과 일관). 1차 근거: BoP.pptx 슬라이드 5·14 + background/note/12·23
- [x] **[background-search]** 상품무역 시트의 한국어 정의·세부 항목(귀금속·非귀금속 등)·측정 단위 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §5 Table_E. 한국어 STAT_NAME(「상품무역」), 슬라이드 5 정의 "재화의 수출입, net trade in merchandise goods", 3 부표(Exports/Imports/Balance, 451행 × 9열) + SITC 5분류, 세부 항목(general merchandise·goods for processing·repairs on goods·goods procured in port·non-monetary gold) — 비통화용 금은 Table_BX에서 분리 처리, 측정 단위 GBP million 분기·연간(1997~2025), 부호 해석(Exports + / Imports −, Balance = Exports − Imports → 영국 만성 적자), Table_B 상품수지·Table_BX·슬라이드 21 분석(한국 BoP 상품수지≈무역수지 vs 영국 분리)까지 6 블록 충족. **세부 항목의 일부(SITC 5분류·EBOPS 매핑)는 강의 자료 미수록 → background/note/10 ONS UK Trade Glossary 보강**. 1차 근거: BoP.pptx 슬라이드 5·9·21 + background/note/02·08·10·12
- [x] **[background-search]** 서비스무역 시트의 한국어 정의·세부 항목(여행·운송·금융·기타비즈니스 등)·측정 단위 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §6 Table_F. 한국어 STAT_NAME(「서비스무역」), 슬라이드 5 정의 "서비스의 수출입(운수·여행·로열티 등 포함)", EBOPS 2010 12분류(가공 서비스·유지보수·운송·여행·건설·보험연금·금융·IP사용료·통신컴퓨터·기타비즈니스·개인문화·정부) — 451행 × 13열(12분류 + 합계), 측정 단위 GBP million 1997~2025, 부호 해석(Exports + / Imports −, 영국 만성 흑자, Financial·Other business·Travel 주도), Table_B 서비스수지 합치 정합 + 슬라이드 21 `Balance of Trade = goods + services` 관계까지 6 블록 충족. 자료원 보강: ITIS(서비스무역 50% 이상)·IPS(Travel). **EBOPS 2010 12분류 명세는 강의 자료 미수록 → background/note/10 (UN MSITS 2010) 보강**. 1차 근거: BoP.pptx 슬라이드 5·22 + background/note/02·10·12·22
- [x] **[background-search]** 1차소득 시트의 한국어 정의·세부 항목(직접투자수익·증권투자수익·기타투자수익·근로자보수)·부호 해석 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §7 Table_G. 한국어 STAT_NAME(「1차소득(본원소득)」), 슬라이드 5 정의 "임금송금·배당·이자 등(income receipts from Korea-owned assets abroad − income payment on foreign owned assets in Korea)", 02회차 "대가성 소득(노동·자본 제공의 대가)" 본질, 세부 2분해 — 근로자 보수(Compensation of employees, 노동 대가) + 투자소득(Investment income, 자본 대가) 3분해(직접투자수익·증권투자수익·기타투자수익) Table_D1_3·D4_6·D7_9 sub3과 양면 회계 매핑, 측정 단위 GBP million 1997~2025(451행 × 11열), 부호 해석(Credit + / Debit −, 슬라이드 11 자국 자산 수익 우위 + / 부채 비용 우위 −), 영국 만성 흑자 → 2025 Q4 적자 전환(REPORT.md 인용) + 슬라이드 25 BoP(flow) ↔ IIP(stock) 연결(영국 자산 측 수익률 > 부채 측 수익률로 만성 순채무국임에도 1차소득 흑자가 가능)까지 6 블록 충족. 1차 근거: BoP.pptx 슬라이드 5·6·9·11·25 + background/note/02·12·19
- [x] **[background-search]** 2차소득 시트의 한국어 정의·세부 항목(이전소득의 종류)·부호 해석 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §8 Table_H. 한국어 STAT_NAME(「2차소득(이전소득)」), 슬라이드 5 정의 "아무런 대가 없이 제공되는 것으로 원조·국제기구출연금 등 포함", 02회차 본질 "무상(unilateral) 이전, 본원소득과 대칭(대가 無 vs 대가 有)", 세부 분해(General government 부문 + Other sectors 부문, 451행 × 14열, 추정), 측정 단위 GBP million 1997~2025, 부호 해석(Credit + / Debit −, 영국은 EU 분담금·해외 원조 지급으로 만성 적자 구조화), Table_B Secondary income 정합 + 슬라이드 14 항등식 `CA = Goods + Services + Primary + Secondary` + 영국 적자 구조 분석(`|G적자|+|SI적자| > |S흑자|+|PI흑자|` → CA 적자)까지 6 블록 충족. **세부 항목 분류(personal transfers·workers' remittances·technical assistance grants·EU contributions 등)는 강의 자료 미수록 → BPM6 §12 외부 표준·Pink Book Ch.6 보강 권고**(note/12). 1차 근거: BoP.pptx 슬라이드 5·14 + background/note/02·12
- [x] **[background-search]** 자본계정 시트의 한국어 정의·자본이전·비생산비금융자산 거래 의미 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §9 Table_I. 한국어 STAT_NAME(「자본수지」), 슬라이드 5 정의 "그 외 자산 및 부채의 금융거래 기록, transactions of fixed or nonfinancial assets (very small)" + 슬라이드 7 보강 "국가 간 부의 이전을 초래하는 그 외 다른 거래·자본이전·비생산비금융자산 또는 무형자산 취득·처분", **자본이전 의미**(시장거래와 무관한 일방적 이전 — 채무면제·자본 보조금·이민에 따른 자산이동), **비생산비금융자산 의미**(토지(외국대사관 부지)·지하자원·특허·상표 — 생산되지 않고 금융자산도 아닌 자산의 거주자/비거주자 간 거래), 측정 단위 GBP million 1997~2025(451행 × 14열), 부호 해석(Credit + / Debit −, 강의 슬라이드 5 "very small" → 강의 항등식 단순화 시 KA=0 가정 → `CA = FA(broad)`로 다뤄짐), 표적 항등식 `CA + KA + FA + E&O ≡ 0`(04회차)와의 관계, 슬라이드 26 매트릭스(자본수지 행: 기타자본수지·자본이전·비금융자산취득 3열 분해)까지 6 블록 충족. 1차 근거: BoP.pptx 슬라이드 5·7·14 + background/note/02·04·08·12
- [x] **[background-search]** 금융계정 시트의 한국어 정의·자산/부채 부호 해석(음수 = 영국으로의 순자본 유입) 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §10 Table_J. 한국어 STAT_NAME(「금융계정(NSA)」), 슬라이드 6 정의 "자산 및 부채의 소유권 변동과 관련된 거래" + 슬라이드 14 항등식 `Financial account = Net acquisition of foreign financial assets − Net incurrence of liabilities + Net financial derivatives` + 02회차 광의 정의 "광의 금융계정 = 비준비 FA + 준비자산", **자산/부채 부호 해석**(슬라이드 8 BPM6 변경 — "자산·부채 증감 기준": 자산 증가 + / 부채 증가 +; 슬라이드 11 "금융수지(준비자산 제외) 흑자 = 대외순자산 증가, 적자 = 순차입 증가"), **음수 = 영국으로의 순자본 유입 해석**(영국은 만성 CA 적자국 → `CA = FA(broad)` 항등식에서 FA 합계 (−) → 자산 순취득 < 부채 순발행 = 부채 순증 = 외국으로부터의 순자본 유입; note/03 영국 적용 주의점), Table_J 특이점 — sign_prefix(공백+마이너스) prefix 부착(부표1·3 + D1_3·D7_9 유량, 부표2 부채측은 미부착, ETL에서 `_neg_<cdid>` 컬럼명으로 보존), 측정 단위 GBP million NSA(계절미조정) 1997~2025(451행 × 14열), Table_J 부표 1/2/3 = NAFA/NIL/Net 3축(19회차 매핑) + Table_D1_3·D4_6·D7_9 양면 회계 + Table_K(IIP) 저량 종합 + 영국 NEO 잔차로 사후 항등성 미달(20회차 |NEO|/GDP 평균 0.92%)까지 6 블록 충족. 1차 근거: BoP.pptx 슬라이드 6·8·9·11·14 + background/note/03·06·12·19
- [x] **[background-search]** 직접투자·증권투자·금융파생상품·기타투자·준비자산 각 항목의 한국어 정의와 BoP 매뉴얼상 분류 기준 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §11 (5분류 정밀, line 161~204). 슬라이드 6 직접 정의 5개를 19회차 NAFA·NIL 양면 매핑과 결합. **§11-1 직접투자(DI)**: "외국기업 자금투입+경영참가" + BPM6 §6.12 의결권 10% 임계(note/10) + OECD BD4(note/16) + ONS SPE 포함·제외 두 시리즈 + 양면 N2SV/N2SA/MU7M·N2V3/N2UG/MU7O. **§11-2 증권투자(PI)**: "가치증가 목적, 주식·채권" + 의결권 10% 미만 + Equity·Debt 2분할 + 양면 HHZC/HHZF/HHZD·HHZZ/HLXW/CGNH. **§11-3 파생상품(FD)**: "파생금융상품거래 기록" + 슬라이드 14 `+ Net financial derivatives` 순액 표기 + ONS 유량 자산/부채 분리 부재(net ZPNN만) + IIP 저량 양면 JX96/JX97/JX98. **§11-4 기타투자(OI)**: "대출·차입·무역신용·현금예금" + 잔여(residual) 분류 + 양면 XBMM/XBMN/HHYR·HLXV/HLYD/CGNG + 자료원 BIS Locational + BoE. **§11-5 준비자산(IR)**: "통화당국이 보유하는 국제유동성수단의 증감" + 화폐용 Gold·SDR·IMF reserve position·외화자산 4구성 + 영국 EEA(HMT+BoE) + 2025-10 net USD 112.4 bn(note/17) + 양면 자산만 LTCV·LTEB(부채측 부재가 정상) + **BoP/IIP 부호 비대칭**(슬라이드 26: BoP flow 음 / IIP stock 양). 본 단위는 강의 자료 직접 정의 5개 + BPM6/BD4 외부 표준 보강(note/10·16) 결합 — 6 블록 충족. 1차 근거: BoP.pptx 슬라이드 6·8·9·11·14·26 + background/note/06·08·10·16·17·19
- [x] **[background-search]** 국제투자대조표(IIP) 시트의 한국어 정의·자산/부채/순대외자산 개념·BoP 거래 흐름과의 관계 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §12 Table_K(+ Table_D1_3/D4_6/D7_9 보강, line 208~224). 한국어 STAT_NAME(「국제투자대조표(분기말)」), 슬라이드 25 정의 "특정 시점에서 한 국가의 대외투자 잔액과 외국인의 국내투자 잔액 및 그 변동내역" + 슬라이드 4 "stock means gross" + 슬라이드 25 "BoP는 flow, IIP는 stock", **자산/부채/순대외자산 개념**(슬라이드 11 "금융수지 흑자 = 대외순자산 증가 / 적자 = 순차입 증가" + 슬라이드 24 `(X − IM) = ΔNFA` → Net IIP = 총자산 − 총부채 = NFA), 영국 만성 순채무국(2025 Q4 말 -£199.8 bn, note/17), **BoP 거래 흐름과의 관계**(슬라이드 25 "IIP 증감내역 = 거래요인 + 비거래요인 / 거래요인 = BoP 투자수지 + 준비자산증감 합계와 일치" → `ΔNet IIP(t) = [FA(t) + ΔReserve(t)] + [재평가·환율·기타조정](t)`, 슬라이드 26 매트릭스 도식화) + 영국 비거래요인(재평가) > 거래요인 영향(note/05) + 분기 단위 재평가 3분해는 ONS xlsx 미포함(Pink Book Dataset 8 별도, note/18), 측정 단위 GBP billion(주의: Table_B/F/G/H GBP million과 다름) NSA 1997~2025(451행 × 11열), 부호 해석(슬라이드 8 BPM6 자산↑+/부채↑+, Reserve BoP/IIP 부호 비대칭 슬라이드 26), Table_J flow 누적 + 비거래요인 = Table_K stock 관계까지 6 블록 충족. 슬라이드 24 식 `NFA + DC = H`는 영국의 변동환율·인플레이션 타게팅 체계에서 직접 적용 한계(note/04 영국 ONS 적용 시 주의점). 1차 근거: BoP.pptx 슬라이드 4·8·11·14·24·25·26 + background/note/05·12·17·18·19
- [x] **[background-search]** 직전 발표 대비 개정 시트들의 한국어 정의·개정 발생 원인·해석 시 유의점 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §13 Table_R1·R2·R3 (line 228~246). 한국어 STAT_NAME(R1「개정 요약(잔액)」/ R2「경상수지 개정」/ R3「국제투자 개정」), 한국어 정의 "직전 발표(2025 Q3 Statistical Bulletin) 대비 본 발표(2025 Q4)에서 변경된 시계열 값의 차이 게재", **개정 발생 원인** 3건(① 다중 출처의 후행 도착 — HMRC OTS 월간 → ITIS·IPS 분기 → AIFDI/AOFDI 연간 → BIS 분기 t+4개월의 시차로 잠정치 → 확정치 교체, ② ONS National Accounts Revisions Policy 2024-05·2025-06 갱신 — 직전 분기 외 시계열은 두 번째 릴리스 시 일괄 갱신, Pink Book에서 모든 자료원 동시 reconcile, ③ 2023~2025 HMRC 수입·ITIS 처리 시스템 오류 → 2021년 이후 전 기간 개정 — note/22), **해석 시 유의점**(NEO 분기별 변동으로 항등식 실측 미성립 + 개정에 따라 NEO도 변동, 20회차 |NEO| 평균 5,872 £m·최대 14,457 £m), 세부 구조(R1: 445×13 Ch.01~08 잔액 / R2: 592×13 CA 4 부표 / R3: 1327×7 IIP 9 부표 수직 적층), 부호 해석(현재발표값 − 직전발표값, + 상향 / − 하향 개정), R3 단위 GBP billion(R1·R2 GBP million과 다름), 다른 변수와의 관계(R1↔Table_A, R2↔Table_B/BX/C·E/F/G/H, R3↔Table_D1_3/D4_6/D7_9·J·K)까지 6 블록 충족. **개정 개념 자체는 강의 자료 미수록 → background/note/10·12·20·22 외부 보강 완료**(Phase 3.4 명세서에서 명시 표기 필요). 1차 근거: background/note/10(ONS Revisions Policy)·12·20·22 + BoP.pptx 슬라이드 26(가장 가까운 인접 개념 = 비거래요인 분해)
- [x] **[background-search]** 메타·주석 시트의 한국어 정의·역할 요청 — 산출물: `db/data/_inventory/23_sheet_definitions.md` §14 Cover_sheet·Notes·Records (line 250~263). 한국어 STAT_NAME(Cover_sheet「표지·목차」/ Notes「공통 주석」/ Records「분기 신기록 요약」), **각 시트 역할**(① Cover_sheet 30×19 — 분기 발표 식별 정보(분기·발표일) + 17개 본표 + 3개 메타 시트 색인(table of contents); ② Notes 51×8 — 10 sub-tables 공통 주석, **핵심 주석 "reverse the sign of series prefixed with a minus"** 가 Table_J·D1_3·D7_9의 sign_prefix 컬럼에 적용되는 부호 반전 규칙 — 슬라이드 8 BPM6 부호 규약 변경의 ONS 운영적 구현 방식; ③ Records 35×5 — 분기 단위 신기록(highest/lowest 관측치) GBP billion 단위 요약 + Pink Book Ch.01 Main points 대응), 다른 변수와의 관계(Notes 시트 sign_prefix 규칙 = Table_J 부표1·3, D1_3 sub2, D7_9 sub2 자동 처리 시 핵심 메타데이터 — 19회차 §sign_prefix 패턴; 슬라이드 8 BPM5↔BPM6 부호 변경의 운영적 풀이), 부호 해석(메타 시트 자체는 데이터 값 없음, Notes 부호 규칙은 슬라이드 8 + 11 정의의 운영 표현)까지 6 블록 충족. **메타 시트(ONS 표지·주석·기록)는 강의 자료 미수록 → background/note/10 (ONS Service Manual)·12 (시트별 인벤토리)·19 (sign_prefix 패턴) 외부 보강 완료**. 1차 근거: background/note/12·10·19 + BoP.pptx 슬라이드 8 (BPM6 부호 변경 — Notes 시트의 운영적 위치)
...
- [x] **[background-search]** 1차 정의 결과에서 강의 자료에 등장하지 않는 CDID는 명시적으로 표시되었는지 확인 — 자동 점검 통과: `cdid_definitions.csv`의 `source` 컬럼이 두 가지 표지로 명시 구분 — ① 강의 슬라이드 직접 매핑 193건은 `"강의 슬라이드(21·22회차 검증) + 13회차 CDID 사전"`, ② 강의 자료 미수록 319건은 `"13회차 CDID 사전(영문 column_label) + 21회차 LVL3 코드표"`로 표기(슬라이드 인용이 source에 포함되지 않음 = 미수록 표지). 동시에 미수록 319건은 별도 파일 `cdid_definitions_unmapped.csv`로 분리되어 있어 **두 가지 명시적 표시(source 컬럼 + 별도 파일)** 가 중복 보장. Phase 3.2 §4 web-search 보강 대상 식별 자동화 가능
- [x] **[web-search]** 강의 자료에 정의가 없는 CDID에 대해 ONS Time Series 페이지·BoP 매뉴얼(IMF BPM6 등) 출처 보강 요청 — 산출물 5종(unmapped 319건 분류별 보강): `background/note/24_ebops_definitions.md`(라운드 1, 서비스무역 EBOPS 2010 12분류 SA~SL — Table_F 33·Table_C 일부)·`25_fa_categories_bpm6.md`(라운드 2, 금융계정 FA 5분류 BPM6/BD5 — Table_J·D1_3·D4_6·D7_9·K 41건)·`26_sitc_goods.md`(라운드 3, 상품무역 SITC Rev.4·BPM6 §10·CIF/FOB·비통화용 금 — Table_E 21·Table_BX 27·Table_B 일부 23 ≈50건)·`27_income_capital.md`(라운드 4·5 통합, 1·2차소득·자본계정 BPM6 §11·§12·§13 — Table_I 29·Table_G 23·Table_H 19 = 71건)·`28_revisions_policy.md`(라운드 6, ONS Revisions Policy + 분기 t+1/t+2/t+annual 일정 — Table_R1 15·R2 23·R3 14 = 52건). 1차 출처 핵심: IMF BPM6 §6~§13(Functional categories·Goods·Primary·Secondary·Capital) + UN MSITS 2010 EBOPS + UN SITC Rev.4 + OECD BD5(2025-03) + IMF CDIS·CPIS + Eurostat ITS6 metadata + ONS BoP QMI·Pink Book·Revisions Policy + Bank of England EEA·BIS Locational + HMRC OTS·HMT EEA Accounts + 한국은행 BPM6. 노트 5종 합계 약 1,300줄, 출처 URL 70건+, 8필드 표준 형식 일관 적용. **확인 못한 부분(BPM6 PDF 403 차단·ONS QMI 일부 미확보 등)은 각 노트 마지막 섹션에 정직 명시**
...
- [x] 단위 정리 표 별도 작성 — 산출물 2종: ① `background/note/29_domain_context.md` §1.4 (시트 22행 × `unit_raw / unit_normalized / scale_factor / 변환 규칙` 4 컬럼 매핑 표 — Table_A·B·BX·C·D1_3·D4_6·D7_9·E·F·G·H·I·J·K·R1·R2·R3·Records·Cover_sheet·Notes 시트 모두 포함, GBP_million 35 부표 / GBP_billion 22 부표 / PCT_GDP 3 부표 / NA 메타 2 시트 분류). ② 기존 `db/data/_inventory/09_units.csv` (시트 단위 unit_normalized 매핑) + `background/note/15_units.csv`(82행 부표 단위 카탈로그). 권고 적재 사양: long-form CSV에 `value_raw·unit_normalized·scale_factor·value_gbp` 4 컬럼 분리(PCT_GDP는 분기 명목 GDP YBHA와 join 필요). Phase 3.4 명세서 단계에서 CSV 정형화로 ETL 가능
- [x] **[background-search]** 결측 표기 분류('x' = 비공개·미산출 / 빈 셀 = 계열 시작 이전 또는 자료 없음)의 강의 자료 또는 통계 일반론적 근거 요청 — 산출물 cross-reference: `background/note/29_domain_context.md` §3.1 (기존 노트 통합) + 1차 위치 `background/note/15_units_and_missing.md` §결측 표기 카탈로그(`x` 360건 = Table_C 1997~1998 EU 시계열 ONS 비공개·suppressed, ONS Notes 11번 명시 / 빈 셀 약 35,000건 = 셀 padding 또는 시리즈 시작 이전 / GAF 권고 [c]/[x]/[z]/[low] 미사용 / legacy `..`/`-` 미사용) + 보완 노트 12 §이상점·노트 13 CDID별 결측 위치. **강의 자료에는 결측 표기 의미가 직접 진술되지 않으며**(노트 13 검증 결과), ONS Notes 시트 메타 정의 "Cells containing x represent unavailable data"가 1차 근거. 적재 정책 권고: `value_raw="x" + value_numeric=NULL + missing_reason="confidential"` 3-컬럼 패턴(노트 15 §후속 작업)
- [x] **[background-search]** BoP 항등식의 거시경제학적 의의(경상수지 적자의 자금조달 측면 해석)를 명세서 도입부에 인용할 한국어 문장으로 작성 요청 — 산출물: `background/note/29_domain_context.md` §2.4 명세서 도입부 인용용 한국어 단락(5문장). 강의 항등식 `CA + KA + FA + E&O ≡ 0` (슬라이드 13 복식부기 항등성 + 슬라이드 14 단순화 항등식 `CA = FA(broad)` + 슬라이드 6 E&O 정의 결합) → 영국 적용 "경상수지 적자 ⇒ 외국으로부터 순차입 ⇒ FA(broad) 부채 순증" 자금조달 해석(슬라이드 11 NFA + 슬라이드 22 `Y−A=CA` + 슬라이드 24 `(X−IM)=ΔNFA` 동치) + 슬라이드 25 BoP(flow) ↔ IIP(stock) 분리 + 영국 NEO(HHDH) 분기 GDP 약 0.9% 변동성(노트 20)으로 잔차 명시 보존 권고. 명세서 도입부에 그대로 인용 가능. 1차 근거: BoP.pptx 슬라이드 6·11·13·14·22·24·25 + background/note/02·04·05·08·20
- [x] **[background-search]** 금융계정 음수가 영국으로의 순자본 유입을 의미한다는 부호 해석을 강의 자료 표현으로 정리 요청 — 산출물 cross-reference: `background/note/29_domain_context.md` §3.2 (기존 노트 통합) + 1차 위치 `background/note/03_sign_conventions.md` §항목별 발췌 표 4·5·6·7행. 강의 표현 결합 — 슬라이드 8 *"새로운 매뉴얼에서는 금융계정 부호표기 방식을 '자산·부채의 증감 기준'으로 변경 … 자산 항목의 부호는 반대 방향으로 바뀜"* (BPM6 부호 약속) + 슬라이드 9 한국 2017년 표 *"신매뉴얼 금융수지 = −87,110"* (흑자임에도 부호 음 — 부호 정의 변경에 따른 표현 변화) + 슬라이드 11 *"금융수지(준비자산 제외) 흑자 = 대외순자산 증가, 적자 = 순차입 증가"*. 영국 적용(노트 03 §영국 ONS 적용 시 주의점 3번): 만성 CA 적자국 → CA(−) ⇒ FA(broad)(−) ⇒ **자산 순취득 < 부채 순발행 = 부채 순증 = 외국으로부터의 순자본 유입**. ONS Table_J 운영 sign_prefix prefix(부표1·3 + D1_3·D7_9 유량) 운영 규칙(노트 12 §sign_convention_text + 노트 19 양면 매핑) + 슬라이드 26 매트릭스 BoP/IIP 부호 비대칭(준비자산 BoP flow 음 vs IIP stock 양, 노트 08). 1차 근거: BoP.pptx 슬라이드 8·9·11·26 + background/note/03·08·12·19

### 3.4 명세서 산출물
- [x] 명세서 컬럼 구성: STAT_CODE / 통계표명 / ITEM_CODE1~4 / 원문 라벨 / 한국어 명칭 / 정의 / UNIT_NAME / CYCLE / START_TIME / END_TIME / 결측 의미 / 부호 규약 / 근거 — 산출물: `db/data/_spec/specification.csv` (512행 × 16 컬럼). 컬럼: STAT_CODE / STAT_NAME / ITEM_CODE1 / ITEM_CODE2 / ITEM_CODE3 / ITEM_CODE4 / ITEM_NAME_EN / ITEM_NAME_KO / DEFINITION / UNIT_NAME / CYCLE / START_TIME / END_TIME / MISSING_MEANING / SIGN_CONVENTION / SOURCE — 체크리스트의 13 컬럼 + 영문/한국어 ITEM_NAME 분리 + ITEM_CODE2·3 분리 명시(ECOS 표준 정렬). 생성 ETL: `db/code/source/build_specification.py`. STAT_CODE 패턴: `UK_BoP_<table_code>_sub<n>` (PLAN.md §0.3 분야 접두 규약). CYCLE: A(연간) / Q(분기). 시점 형식: YYYY / YYYYQn (ECOS 규약)
- [x] 모든 통계항목 코드 행에 한국어 정의 채움 — 자동 점검 통과: `specification.csv` DEFINITION 컬럼 **512/512 (100%) 채움**. 강의 슬라이드 직접 매핑 193행 + Phase 3.2 §4 web-search 보강 노트 24~28(EBOPS·FA·SITC·1·2차소득·자본·개정) 시트별 일괄 정의 319행 = 512. ETL 적용: `build_specification.py`의 SHEET_DEFINITION_TEMPLATE(17 시트) → unmapped 행에 시트 기반 한국어 정의 + classification·column_label 첨부. ko_definition 채움률 37.7%(cdid_definitions.csv) → **100%**(specification.csv) 향상. 강의 슬라이드 직접 매핑 행은 변경하지 않음 — 강의 자료 우선 원칙 유지
- [x] 모든 정의에 출처 인용 동반 (강의 자료 슬라이드 번호 또는 외부 출처 URL) — 자동 점검 통과: `specification.csv` SOURCE 컬럼 **512/512 (100%) 채움**. 강의 슬라이드 직접 매핑 193행은 *"강의 슬라이드(21·22회차 검증) + 13회차 CDID 사전 + background/note/24~28(시트별 보강)"* 형식으로 슬라이드 번호 인용; Phase 3.2 §4 web-search 보강 319행은 *"13회차 CDID 사전 + 21회차 LVL3 코드표 + background/note/<NN>(분류 요지)"* 형식으로 보강 노트 cross-reference. 노트 24~28 §6 출처 카탈로그에는 IMF BPM6·UN MSITS 2010·UN SITC Rev.4·OECD BD5·IMF CDIS·CPIS·Eurostat ITS6·ONS BoP QMI·Pink Book·Revisions Policy·BoE EEA·BIS·HMRC OTS·HMT·한국은행 BPM6 등 70+ URL 인용. 강의 슬라이드 번호(BoP.pptx) + 외부 출처 URL 모두 covered
- [x] **[background-search]** 명세서 초안에 대한 1차 감수 요청 — 강의 자료의 정의와 어긋나는 항목, 부호 규약 오기, 단위 표기 오류 점검 — 산출물: `background/note/30_specification_review.md`. 감수 대상 specification.csv 512행 × 16 컬럼. **결과: 조건부 통과**. ① 강의 자료 정의 정합성 大체로 양호 — STAT_NAME(SA/NSA 약어 풀이 추가 中 권고) / 미수록 표시(Table_BX·C·R1·R2·R3) 100% 명시 적정. ② **高 우선 수정 4건**: ITEM_NAME_KO 행 단위 정밀화(Table_B/C/R1/R2 sub2·sub3 부표 차원 영문 라벨 미반영) + Table_A_sub2 FKMJ(Capital balance) DEFINITION 오기("경상수지 합계"로 채워진 자본수지 행) + 부표 4(% of GDP) UNIT_NAME 단독 분리(현재 시트 단위 통합 표기) + 부표 차원 식별자 DEFINITION 추가. ③ **中 우선 6건**: Table_J sub2 sign_prefix=false 분리 / Table_K BoP-IIP 부호 비대칭 LTEB 한정 / SA-NSA 한국어 풀이 / ITEM_CODE 헤더 의미 메타 / 단위 표기 형식 통일 / START_TIME 분기 정밀도. 1차 근거: BoP.pptx 슬라이드 5~14·25·26 + background/note/02·03·04·08·12·13·15·19·24~28. **수정 권고는 Phase 4 ECOS DB 적재 전 단계로 위임**(ETL 후속 회차에서 일괄 반영)
- [x] 전체 통계표 카탈로그 문서(ECOS 통계표 목록 서비스 대응) 작성 — 산출물: `db/data/_spec/statcatalog.csv` (63 STAT_CODE × 15 컬럼). 컬럼: STAT_CODE / STAT_NAME / ENGLISH_NAME / FIELD_MAIN(국제수지) / FIELD_SUB(시트별 2차 분류 17종) / ORG_NAME(Office for National Statistics, ONS) / DATA_SOURCE(시트별 자료원 — HMRC OTS·ITIS·IPS·BoE·BIS·EEA HMT·FCDO 등) / CYCLE(A·Q) / START_TIME / END_TIME / N_ITEMS / N_OBSERVATIONS / SOURCE_URL(ONS Pink Book) / PUBLISHED_DATE(2026-03-31) / KOREAN_DESCRIPTION. 생성 ETL: `db/code/source/build_statcatalog.py` — specification.csv 512행을 STAT_CODE 단위(`UK_BoP_<table_code>_sub<n>` 패턴)로 그룹화 + long-form CSV에서 관측치 수 집계. 63 STAT_CODE = 본 BoP 데이터셋의 모든 부표(메타 시트 3 제외, 본표 17 시트 × 평균 3.7 부표). ECOS 통계표 목록 서비스 컬럼과 1:1 정렬 (STAT_CODE·STAT_NAME·ORG_NAME·CYCLE·START_TIME·END_TIME 등)
- [x] **[background-search]** 카탈로그 분야 분류명(국제수지·GDP·물가 등)을 강의 자료에서 사용한 한국어 분야명과 일치시키도록 요청 — 산출물: `background/note/31_field_classification.md`. 강의 자료에서 정식 "분야명"으로 다루는 통계는 (a) 국제수지(BoP, 슬라이드 1·3·4·5·... 16회+) + (b) 국제투자대조표(IIP, 슬라이드 4·25·26) 둘. **권고**: `field_classification_main = "국제수지"` (영문 Balance of Payments) + `field_classification_sub = 7군`(메타·주석 / 국제수지 요약 / 경상수지 본표 / 경상수지(지리적 분해) / 경상수지 세부 / 자본·금융계정 / 국제투자대조표(IIP) / 개정(Revisions)) + ECOS 가까운 분야 코드 400번대 참고 병기. **현행 statcatalog.csv(63 STAT_CODE × 15 컬럼)의 FIELD_MAIN/FIELD_SUB 매핑은 본 권고와 100% 정합** — 별도 ETL 수정 없이 통과. 강의 자료에 ECOS 분야 코드 표기 자체는 없음(정직 명시) → 본 노트 §6에 정직 명시. 1차 근거: BoP.pptx 슬라이드 1·3·4·5·6·7·22·25·26 + background/note/02·07·08·12·22·29
...
- [x] **[background-search]** 조회 예시에 사용할 시범 CDID(가장 많이 인용되는 변수, 예: 경상수지 합계·상품무역 합계·서비스무역 합계·순대외자산 등)를 강의 자료에서 추천 요청 — 산출물: `background/note/37_demo_cdids.md`. 강의 자료 등장 빈도 분석(CA 27회·FA 22회·Reserve 19회·IIP 11회) + 본 데이터셋 매핑 검증으로 시범 CDID 10개 확정. 핵심 10개: ① HBOP(경상수지 합계) ② IKBJ(상품·서비스 합계) ③ BOKI(상품수지) ④ IKBD(서비스수지) ⑤ HMBP(1차소득) ⑥ IKBP(2차소득) ⑦ HBNT(금융계정 broad, sign_prefix 부호 반전 데모) ⑧ FNVQ(자본수지) ⑨ HHDH(NEO) ⑩ HBQC(Net IIP) + 참고 LTEB(준비자산 IIP stock). **사용자 후보 정정 2건**: KTMW는 본 데이터셋 부재 → IKBD(Table_F) 대체 / HMBN은 IIP 자산 측 투자소득 합이므로 → IKBP(2차소득)·HMBP(1차소득) 대체. 슬라이드 14 항등식 검증 묶음 4개(HBOP+FNVQ+(−1)·HBNT+HHDH ≈ 0) 단일 STAT_CODE 데모. 학생 학습 우선순위 1~10위 표 포함
...
### 5.1 검증
- [x] 원본 셀 수와 데이터베이스 적재 후 관측치 수 일치 자동 비교 — 산출물: `db/code/source/verify_phase5.py` `verify_cell_count()`. 실행 결과: long-form CSV 74,006행 ↔ observation 74,006행 → **PASS**(차이 0)
- [x] 무작위 표본 10건의 원본 셀 문자열을 원본 엑셀과 직접 대조 — 산출물: `verify_phase5.py` `verify_random_sample(n=10, seed=42)`. 실행 결과: 10건 모두 long-form CSV ↔ observation RAW_CELL 1:1 일치(BOP·BX·F·E·C·K·R3 시트 전반에 분포) → **PASS**
- [x] 사전 분석 보고서 헤드라인 수치를 데이터베이스 조회로 재계산하여 일치 확인 — 산출물: `verify_phase5.py` `verify_headlines()` 5건 모두 차이 0.00% 통과
  - [x] 상품무역 −£65.5bn (2025 Q4) — BOKI / Table_E_sub3 / 실측 −65,496 (기대 −65,496) → PASS
  - [x] 서비스무역 +£53.3bn (2025 Q4) — IKBD / Table_F_sub3 / 실측 +53,335 (기대 +53,335) → PASS
